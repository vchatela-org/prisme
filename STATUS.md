...
| **Dependencies and conflicts had API writes and no screen** — the initiative screen named dependencies by identifier, and the review's ledger step could not close a conflict | found writing the user guide (G8) | 🟢 dependency editor on the initiative screen; resolve buttons in the review · [the entry](docs/50-journal/FUP-2026-09-26-rituals-dependencies-conflicts.md) | — |
